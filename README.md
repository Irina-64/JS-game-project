# Игровой проект курса JavaScript
===

В рамках проекта вам необходимо реализовать ключевые компоненты игры. Игра будет запускаться и работать в браузере.
...
+ Локально и публиковать код в ваш репозиторий [GitHub]
...
1. Установить git.
2. Создайте аккаунт в сервисе [GitHub].
...
Итогом будет наличие папки на локальном компьютере, в которой инициализирован git-репозиторий и настроена связь с репозиторием на [GitHub].
...
2. Открыть заготовку проекта по ссылке:
  ...
  https://codepen.io/Irina64/pen/yLrjyQj
...
6. Отправляйте преподавателю на проверку ссылку на ваш пен.
...
2. Создать новую песочницу «HTML, CSS, JS»
  ...
  https://replit.com/@Irina64/JavaScript-game?v=1
...
1. Попробовать найти ответ сначала самому в интернете. Ведь, именно это скилл поиска ответов пригодится тебе на первой работе. И только после этого спрашивать преподавателя
...
Начинать работу над проектом как можно раньше! Чтобы было больше времени на правки. 
...
2. Откладывать проект на потом. 
3. Ждать ответ на свой вопрос моментально. Преподаватель - работающий сотрудник, который занят, кроме данной дисциплины, другими предметами и проектами. В том числе, и дипломными. Его время ограничено, поэтому постарайтесь задавать правильные вопросы, чтобы получать быстрые ответы! 
